...
class  PaymentApiClient {
    ...
    // MARK: - Declarations -
    /// - Parameter confirmParsingFunction: closure for handling successful 'confirm()' method's result parsing. For conveniance has default implementation already assgined
    static var confirmParsingFunction: ((CoreApiCallResponseEntity, @escaping (_ ticketId: Int) -> Void, @escaping ApiErrorCallback) -> Void) = defautlConfirmParsingFunction
